...
import { LogIn, LogOut, Plus, UsersRound, Zap } from "lucide-react";
        ...
        {session ? (
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="mt-auto h-9 w-9 sm:h-12 sm:w-12 rounded-lg p-0 overflow-hidden transition-all duration-200 hover:rounded-xl focus:rounded-xl"
              >
